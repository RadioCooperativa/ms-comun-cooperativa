...
let _get = async function (req, res, next) {
    try {
        let result = await concesionariaServices.getUser();
        if (result == null) {
...
let _getId = async function (req, res, next) {
    try {
        ...
        let result = await concesionariaServices.getUserId(id);
        if (result === null) {
            res.json(httpStatus.NOT_FOUND);
            res.end();
            return;
...
let _insert = async function (req, res, next){
    try{
        const { params } = req;
        let result = await concesionariaServices.insertUser(params);
...
let _update = async function (req, res, next){
    try{
        const { params } = req;
        let result = await concesionariaServices.updateUser(params);
...
let _delete = async function (req, res, next){
    try{
        const { params:{id} } = req;
        let result = await concesionariaServices.deleteUser(id);
